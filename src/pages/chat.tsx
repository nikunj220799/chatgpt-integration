...
export default function Chat() {
    ...
    return (
        <div className={styles.container}>
            <h2 className={styles.header}>They say Nikunj can answer everything. Why don't you try proving the greatest alive wrong?</h2>
                    ...
                    <MainContainer>
                        <ChatContainer>
                            <MessageList className={styles.chatMessageList}
                                typingIndicator={waitingForResponse && <TypingIndicator content="Nikunj is typing" style={{ background: '#4acfe0' }} />}>
                                {
